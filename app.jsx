    ...
    return (
        <div ref={gridRef} className="mas-videos-grid fixed inset-0 bg-gray-900/95 z-40 overflow-y-auto p-4 md:p-8" tabIndex={0} style={{ outline: 'none' }}>
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-7 lg:grid-cols-7 xl:grid-cols-7 gap-4">
                    ...
                    <div key={categoria} className="mb-10">
                        ...
                        <VideoCarousel>
                            ...
                            {videosEnCarrusel.map((video, index) => (
                                <div key={index} className="flex-shrink-0 w-40 sm:w-52 lg:w-55">
                                    <ReproductorDeVideo 
                                        titulo={video.titulo} 
                                        url={video.url} 
                                        onPlay={setVideoEnFocoUrl} 
                            ...
                            {videosRestantesCount > 0 && (
                                <div className="flex-shrink-0 w-40 sm:w-52 lg:w-55">
                                    <TarjetaMas 
